...
public class AutoConfigurationProcessDemo {
	...
	private static Logger log = LoggerFactory.getLogger(AutoConfigurationProcessDemo.class);
	...
	public CommandLineRunner commandLineRunner() {
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				...
				// 启动运行流程
				ProcessInstance processInstance = startProcessInstance("second_approve20");
				// 处理流程任务
	 ...
	 * 处理流程任务
	 */
	private void processTask(ProcessInstance processInstance) throws Exception {
